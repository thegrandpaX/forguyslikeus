  ...
  return (
    <div className="page-shell">
      <header className="page-header">
        ...
        <h1>Questions, feedback, or just want to say something?</h1>
        <p>
          This site is educational, not therapy. If you're in crisis, call or text 988.
        </p>
      </header>
      ...
      <div className="bento bento--contact">
        ...
        <div className="panel panel--accent" style={{ gridColumn: "2 / 3", gridRow: "1 / 2" }}>
